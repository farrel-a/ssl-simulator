...
int main (int argc, char **argv)
{
    ...
    ros::Subscriber sub5 = nh.subscribe("/ball_on_robot_2",100,br2Callback);
    ...
    ros::Subscriber sub8 = nh.subscribe("/ball_on_robot_3",100,br3Callback);
    ros::Subscriber sub9 = nh.subscribe("/ball_on_robot_1",100,br1Callback);
